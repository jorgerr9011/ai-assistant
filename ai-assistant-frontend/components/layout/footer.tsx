export default function Footer() {
    ...
    return (
        <div className="flex items-end w-full min-h-screen bg-white">
            ...
            <footer className="w-full text-pink-300 bg-pink-100 body-font">
                <div className="container flex flex-col flex-wrap px-2 py-12 mx-auto md:items-center lg:items-center md:flex-row md:flex-no-wrap">
                    <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                        <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">

                        </a>
                        <p className="mt-2 text-lg text-gray-700">AxudaIA</p>
                        <div className="mt-4">
                    ...
                    <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            ...
                            <nav className="mb-10 list-none">
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-900">Home</a>
                                </li>
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-900">ChatIA</a>
                                </li>
                                <li className="mt-3">
                                    <a className="text-gray-500 cursor-pointer hover:text-gray-900">Incidence</a>
                                </li>
                            </nav>
                        </div>
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
